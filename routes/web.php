...
//User
Route::get('userList/{username?}', 'UserController@userList')->name('userList');
...
Route::get('list/{category?}/{name?}','FilmController@filmList')->name('list');
Route::get('getChart','FilmController@getChart');
