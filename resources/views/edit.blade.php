    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img class="card-img-top" alt="Bootstrap Thumbnail Third" src="{{ $film->path }}"  style="width: 350px;height: 200px;padding:0px; margin:0 auto; left: 0; right: 0; text-align: center; margin-bottom: 20px; margin-left: 110px" />
