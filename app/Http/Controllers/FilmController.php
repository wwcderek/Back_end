...
//            ->select('films.title' ,DB::raw("group_concat(role_has_film.role_id)"))
            ->select('films.title', 'films.description', 'films.language', 'films.rating', 'films.running_time', 'films.punlish_time', 'films.path',DB::raw("(group_concat(roles.name SEPARATOR ' ')) as 'role_name'"))
            ->groupBy('films.title')
